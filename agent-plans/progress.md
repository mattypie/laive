...
- Reworked the Max sidecar source patch to use a fixed-width ASCII `laive` banner as the deterministic in-Live device UI, while keeping `logo.png` packaged for docs and future Max rendering experiments.
