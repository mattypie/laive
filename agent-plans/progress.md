...
| `v0.7.0` | Arrangement view | In progress: arrangement clips now flow into track details and arrangement summaries, arrangement loop/transport control is wired through the bridge and MCP surface, and arrangement clip creation now falls back to session-to-arrangement duplication when direct arrangement clip writes are unavailable in the active Live runtime |
